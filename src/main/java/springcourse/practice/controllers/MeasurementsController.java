...
import springcourse.practice.dto.MeasurementDTO;
import springcourse.practice.dto.MeasurementsResponse;
import springcourse.practice.models.Measurement;
import springcourse.practice.services.MeasurementService;
...
public class MeasurementsController {
    ...
    public MeasurementsResponse getMeasurements() {
        // обычно список из элементов оборачивается в один объект для пересылки (MeasurementResponse)
